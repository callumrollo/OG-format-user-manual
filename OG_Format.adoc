...
OceanGliders format - Terms of References

* https://github.com/OceanGlidersCommunity/OG-format-user-manual[Repository]
* https://callumrollo.github.io/OG-format-user-manual/OG_Format.html[Terms of reference]
* https://callumrollo.github.io/OG-format-user-manual/vocabularyCollection/tableOfControlledVocab.html[Vocabulary collections]
